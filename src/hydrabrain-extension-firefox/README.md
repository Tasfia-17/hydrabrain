...
- **File upload limits** — Firefox can re-fetch a prior `downloadId` or open HydraBrain's own user file picker, but cannot silently attach an arbitrary local path.
