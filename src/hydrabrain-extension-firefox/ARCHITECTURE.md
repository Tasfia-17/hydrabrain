# HydraBrain Firefox Extension — Architecture
...
HydraBrain Cloud, seven local backends, Azure OpenAI, AWS Bedrock, Anthropic, and
...
| No arbitrary-path/CDP upload | Cannot attach an arbitrary local path silently | Use a prior `downloadId` re-fetch or HydraBrain's user file picker |
