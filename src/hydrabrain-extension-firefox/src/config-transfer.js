...
export function createConfigExport(stored = {}, options = {}) {
  ...
  return {
    ...
    hydrabrainVersion: String(options.hydrabrainVersion || 'unknown'),
...
export function parseConfigImport(json) {
  ...
  return {
    ...
    sourceVersion: typeof parsed.hydrabrainVersion === 'string' ? parsed.hydrabrainVersion : '',
  };
}
...
export function mergeConfigPatchSettings(current = {}, patch = {}) {
  ...
  // replace the runtime's current HydraBrain Cloud configuration.
  delete patchProviders.hydrabrain_cloud;
