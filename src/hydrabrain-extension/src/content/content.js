...
(() => {
  ...
  const SET_CHECKED_MARKER_ATTRIBUTE = 'data-hydrabrain-set-checked-target';
  ...
  const DEV_TARGET_MARKER_ATTR = 'data-hydrabrain-dev-target';
  ...
  function highlightDevElement(params) {
    ...
    overlay.setAttribute('data-hydrabrain-dev-highlight', '');
