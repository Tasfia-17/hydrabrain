 ...
 */
(() => {
  const PROBE_EVENT = 'hydrabrain:file-picker-guard-probe';
  const PROBE_ATTR = 'data-hydrabrain-file-picker-probe';
  const PROBE_ACK_ATTR = 'data-hydrabrain-file-picker-probe-ack';
  const ARM_EVENT = 'hydrabrain:file-picker-guard-arm';
  const DISARM_EVENT = 'hydrabrain:file-picker-guard-disarm';
  const RESET_EVENT = 'hydrabrain:file-picker-guard-reset';
  const BLOCKED_EVENT = 'hydrabrain:file-picker-guard-blocked';
  const GUARD_ATTR = 'data-hydrabrain-file-picker-guard';
  const BLOCKED_ATTR = 'data-hydrabrain-file-picker-blocked';
