...
export const STORE_URLS = {
  chrome: 'https://chromewebstore.google.com/detail/hydrabrain/ljhijonmfahplgbbacgcfnaihbjljhhb',
  firefox: 'https://addons.mozilla.org/en-US/firefox/addon/hydrabrain/',
};

export const FEEDBACK_ISSUES_URL = 'https://github.com/hydrabrain-one/hydrabrain/issues/new';
...
export function buildFeedbackUrl({ rating, comment = '' } = {}) {
  const title = encodeURIComponent(`HydraBrain feedback (${rating}/5)`);
  const bodyParts = [
    `**Rating:** ${rating}/5`,
    '',
    ...
    '',
    '---',
    '_Submitted from the HydraBrain side panel feedback prompt._',
  ];
