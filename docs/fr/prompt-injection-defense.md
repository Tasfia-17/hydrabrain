...
L'agent de HydraBrain agit **à l'intérieur de la session navigateur authentifiée de l'utilisateur** : il
...
`"resultPolicy": "untrusted"` dans le manifeste `hydrabrain-tools` de la compétence à la place ;
